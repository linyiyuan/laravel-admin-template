...
// ================== 需要Token认证的接口路由 ==================
        Route::middleware(['refresh.token'])->group(function(){
            ...
            Route::middleware(['check.permission','record.operate'])->group(function(){
                ...
                //图床相关接口
                Route::group(['prefix' => 'picture_bed', 'namespace' => 'PictureBed'] ,function(){
                    Route::resource('photo_album', 'PhotoAlbumController');     //相册管理
                    Route::resource('photo', 'PhotoController');     //图片管理
                });
                ...
                Route::group(['prefix' => 'system', 'namespace' => 'System'], function() {
                    ...
                    Route::get('get_netraffic', 'NetrafficController@netraffic');           //获取流量监控数据
                    Route::get('get_web_siteList', 'NetrafficController@getWebSiteList');    //获取站点
                });
